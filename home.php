...
<html lang="en">
    ...
    <body>
        ...
        <div class="w3-content w3-section" style="max-width:700px">
          <img class="mySlides" src="wallpapers/1.jpg" style="width:50%">
          <img class="mySlides" src="wallpapers/2.jpg" style="width:50%">
        ...
        <div class="details-page">
          <input style="background-color: #FBA817;border: none;padding: 8px 32px;text-align: center;text-decoration: none;display: inline-block; cursor: pointer;border-radius: 20px;width: 18em; font-weight: bold;  color: #000; border-radius: 10px;  font-size: 16px;" type="button" value="Thuparamaya" onclick="window.location.href='thuparama.php'" />
          <br><br>
          <input style="background-color: #FBA817;border: none;padding: 8px 32px;text-align: center;text-decoration: none;display: inline-block; cursor: pointer;border-radius: 20px;width: 18em; font-weight: bold;  color: #000; border-radius: 10px;  font-size: 16px;" type="button" value="Kuttam Pokuna" onclick="window.location.href='kuttam.php'" />
          <br><br>
          <input style="background-color: #FBA817;border: none;padding: 8px 32px;text-align: center;text-decoration: none;display: inline-block; cursor: pointer;border-radius: 20px;width: 18em; font-weight: bold;  color: #000; border-radius: 10px;  font-size: 16px;" type="button" value="Temple of tooth" onclick="window.location.href='temple.php'" />
          <br><br>
          <input style="background-color: #FBA817;border: none;padding: 8px 32px;text-align: center;text-decoration: none;display: inline-block; cursor: pointer;border-radius: 20px;width: 18em; font-weight: bold;  color: #000; border-radius: 10px;  font-size: 16px;" type="button" value="Nissankalatha Mandapaya" onclick="window.location.href='nissanka.php'" />
          <br><br>
          <input style="background-color: #FBA817;border: none;padding: 8px 32px;text-align: center;text-decoration: none;display: inline-block; cursor: pointer;border-radius: 20px;width: 18em; font-weight: bold;  color: #000; border-radius: 10px;  font-size: 16px;" type="button" value="Ruwanwelisaya" onclick="window.location.href='ruwanweli.php'" />
          <br><br>
          <input style="background-color: #FBA817;border: none;padding: 8px 32px;text-align: center;text-decoration: none;display: inline-block; cursor: pointer;border-radius: 20px;width: 18em; font-weight: bold;  color: #000; border-radius: 10px;  font-size: 16px;" type="button" value="Gangaramaya" onclick="window.location.href='gangaramaya.php'" />
        </div>
