...
<html lang="en">
    ...
    <body>
        ...
        <div class="details-page" >
          ...
          <br><br>
          <input style="background-color: #FBA817;border: none;padding: 8px 32px;text-align: center;text-decoration: none;display: inline-block; cursor: pointer;border-radius: 20px;width: 18em; font-weight: bold;  color: #000; border-radius: 10px;  font-size: 16px;" type="button" value="Kuttam Pokuna" onclick="document.getElementById('id01').style.display='block'" />
          <br><br>
          <input style="background-color: #FBA817;border: none;padding: 8px 32px;text-align: center;text-decoration: none;display: inline-block; cursor: pointer;border-radius: 20px;width: 18em; font-weight: bold;  color: #000; border-radius: 10px;  font-size: 16px;" type="button" value="Temple of tooth" onclick="document.getElementById('id01').style.display='block'" />
          <br><br>
          <input style="background-color: #FBA817;border: none;padding: 8px 32px;text-align: center;text-decoration: none;display: inline-block; cursor: pointer;border-radius: 20px;width: 18em; font-weight: bold;  color: #000; border-radius: 10px;  font-size: 16px;" type="button" value="Nissankalatha Mandapaya" onclick="document.getElementById('id01').style.display='block'" />
          <br><br>
          ...
          <br><br>
          <input style="background-color: #FBA817;border: none;padding: 8px 32px;text-align: center;text-decoration: none;display: inline-block; cursor: pointer;border-radius: 20px;width: 18em; font-weight: bold;  color: #000; border-radius: 10px;  font-size: 16px;" type="button" value="Gangaramaya" onclick="document.getElementById('id01').style.display='block'" />
        </div>
